...
hotkey_regex = (
    r"^(?:[\^!+#<>]+(?<key>[a-zA-Z0-9]|F[1-9]|F1[0-2]|"
    r"CapsLock|Space|Tab|Enter|Esc|Backspace|ScrollLock|Del|Ins|Home|End|PgUp|PgDn|Up|Down|Left|Right|"
    r"Numpad0|Numpad1|Numpad2|Numpad3|Numpad4|Numpad5|Numpad6|Numpad7|Numpad8|Numpad9|"
    r"NumpadDot|NumLock|NumpadDiv|NumpadMult|NumpadAdd|NumpadSub|NumpadEnter)$|"
    r"(?<key2>[a-zA-Z0-9]|F[1-9]|F1[0-2]|"
    r"CapsLock|Space|Tab|Enter|Esc|Backspace|ScrollLock|Del|Ins|Home|End|PgUp|PgDn|Up|Down|Left|Right|"
    r"Numpad0|Numpad1|Numpad2|Numpad3|Numpad4|Numpad5|Numpad6|Numpad7|Numpad8|Numpad9|"
    r"NumpadDot|NumLock|NumpadDiv|NumpadMult|NumpadAdd|NumpadSub|NumpadEnter)"
    r"(?:\s*&\s*(?!\k<key2>\b)(?:[a-zA-Z0-9]|F[1-9]|F1[0-2]|"
    r"CapsLock|Space|Tab|Enter|Esc|Backspace|ScrollLock|Del|Ins|Home|End|PgUp|PgDn|Up|Down|Left|Right|"
    r"Numpad0|Numpad1|Numpad2|Numpad3|Numpad4|Numpad5|Numpad6|Numpad7|Numpad8|Numpad9|"
    r"NumpadDot|NumLock|NumpadDiv|NumpadMult|NumpadAdd|NumpadSub|NumpadEnter))?)$"
)

pattern = pcre2.compile(hotkey_regex)
...
class ConfigOverlay:
    ...
    if not pattern.search(reset_hotkey):
        error = (
            "Invalid hotkey. "
            "Check this: https://www.autohotkey.com/docs/v1/Hotkeys.htm#Symbols "
            "The symbols *, ~ and $ are not allowed."
    ...
    if not pattern.search(monster_selected_hotkey):
        error = (
            "Invalid hotkey. "
            "Check this: https://www.autohotkey.com/docs/v1/Hotkeys.htm#Symbols "
            "The symbols *, ~ and $ are not allowed."
